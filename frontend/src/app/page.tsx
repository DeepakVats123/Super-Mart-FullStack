...
export default function Home() {
  ...
  return (
    ...
    <div className="p-2 sm:p-5">
      ...
      <div className="container mx-auto md:px-6">
        <section className="mb-32 text-center">
          <h2 className="mb-12 text-3xl dark:text-slate-500 font-bold">
            There are good reasons to <u className="text-primary dark:text-primary-400">be proud</u>
          </h2>
          <div className="grid md:grid-cols-3 lg:gap-x-12">
            <div className="mb-12 md:mb-0">
              <div className="mb-6 inline-block rounded-md bg-primary-100 dark:text-slate-400 p-4 text-gray-500">
              ...
              <h3 className="mb-4 text-2xl font-bold text-primary dark:text-slate-500  dark:text-primary-400">
                25000
              </h3>
              <h5 className="text-lg font-medium dark:text-slate-400 text-gray-500">
                Happy customers
              </h5>
            </div>

            <div className="mb-12 md:mb-0">
              <div className="mb-6 inline-block rounded-md bg-primary-100 p-4 text-primary text-gray-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2"
              ...
              <h5 className="text-lg font-medium dark:text-gray-400 text-gray-500">
                Growth
              </h5>
            </div>
        ...
        <section className="mb-32">
          <div className="flex justify-center">
            <div className="max-w-[700px] text-center">
              <p className="mb-6 font-bold dark:text-slate-400 text-slate-700 uppercase text-primary dark:text-primary-400">
                Features
              </p>
              <h2 className="mb-12 text-3xl dark:text-slate-500 font-bold">Why is it so great?</h2>
              <p className="mb-16 dark:text-slate-500 text-slate-600">
          ...
          <div className="grid gap-x-6 md:grid-cols-2 lg:grid-cols-4 xl:gap-x-12">
            <div className="mb-12">
              <div className="flex">
                <div className="shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2"
                    stroke="currentColor" className="mr-3 h-5 w-5 dark:text-slate-500 text-success">
                    <path strokeLinecap="round" strokeLinejoin="round"
            ...
            <div className="mb-12">
              <div className="flex">
                <div className="shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2"
                    stroke="currentColor" className="mr-3 dark:text-slate-500 h-5 w-5 text-success">
                    <path strokeLinecap="round" strokeLinejoin="round"
                      d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
            ...
            <div className="mb-12">
              <div className="flex">
                <div className="shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2"
                    stroke="currentColor" className="mr-3 h-5 dark:text-slate-500 w-5 text-success">
                    <path strokeLinecap="round" strokeLinejoin="round"
                      d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
      ...
      <div className="container -my-16 mx-auto border-t-2 dark:border-gray-500 border-gray-600 pt-6 md:px-6">
        <section className="mb-32 text-center">
        <h2 className="mb-12 text-3xl  dark:text-slate-500 font-bold">
                  Meet the <u className="text-primary dark:text-primary-400">team</u>
                </h2>
          ...
          <div className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
            <div className="mb-12 md:mb-0">
              ...
              <h5 className="mb-2 text-lg font-bold dark:text-gray-400">Maria Smantha</h5>
              <h6 className="mb-4 font-medium text-primary dark:text-slate-500 dark:text-primary-400">
                Web Developer
              </h6>
              <p className="mb-4 text-gray-600 dark:gary-500">
            ...
            <div className="mb-12 md:mb-0">
              ...
              <h5 className="mb-2 text-lg dark:text-slate-500 font-bold">Lisa Cudrow</h5>
              <h6 className="mb-4 dark:text-slate-500 font-medium text-primary dark:text-primary-400">
                Graphic Designer
              </h6>
              <p className="mb-4 text-gray-600 dark:gary-500">
            ...
            <div className="mb-0">
              ...
              <h5 className="mb-2 text-lg dark:text-slate-500 font-bold">John Smith</h5>
              <h6 className="mb-4 dark:text-slate-500 font-medium text-primary dark:text-primary-400">
